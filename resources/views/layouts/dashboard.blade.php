...
<h1>Welcome {{ Session::get('name')  }} <br>|<br> All Bloggers</h1>

<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Add User</button>
<a href="/blogstatus"><button style="width:auto;">View Blog's Status</button></a>
...
<table>
    ...
    <tr>
        ...
        <td>{{ $user->email }}</td>
        <td>{{ $user->role }}</td>
        <td><a href="/delete/{{ $user->id }}" onclick="return confirm('Are you sure you want to delete this user?')"><i class="fa fa-trash"></i></a></td>
    </tr>
    @endforeach
</table>
